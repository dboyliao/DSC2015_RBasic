...
![Matrix1](~/Dropbox/Rprojects/RBasic1/img/R_Basic_Matrix.png)

---

<p style="font-size:36px"> DataFrame Row的概念</p>

![MatrixRow](~/Dropbox/Rprojects/RBasic1/img/R_Basic_Matrix_row.png)

---

<p style="font-size:36px"> DataFrame Column的概念

![MatrixRow](~/Dropbox/Rprojects/RBasic1/img/R_Basic_Matrix_col.png)
